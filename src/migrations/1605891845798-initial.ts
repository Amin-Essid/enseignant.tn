...
export class initial1605891845798 implements MigrationInterface {
    name = 'initial1605891845798'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "post" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "filename" character varying NOT NULL, "type" character varying NOT NULL, "level" character varying NOT NULL, "language" character varying NOT NULL, "text" character varying, "unit" character varying, "field" character varying, "points" integer NOT NULL DEFAULT 0, "creatorId" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_be5fda3aac270b134ff9c21cdee" PRIMARY KEY ("id"))`);
